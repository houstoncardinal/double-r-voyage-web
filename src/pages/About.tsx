  ...
  return <>
      ...
      <section className="relative bg-gradient-to-br from-slate-50 via-white to-blue-50/30 pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-20 left-20 w-48 h-48 bg-gradient-to-br from-purple-200/20 to-blue-200/15 rounded-full opacity-40 animate-float blur-2xl" style={{
            animationDelay: '2s'
          }}></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-20">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-blue-200/30 shadow-xl hover:shadow-2xl transition-all duration-300">
              ...
              <div className="space-y-4">
                {["15+ years of transportation excellence in Houston and nationwide", "DOT certified and fully insured operations with comprehensive coverage", "Real-time GPS tracking on all shipments for complete transparency", "24/7 customer support and communication for peace of mind", "Specialized expertise in port logistics and auto transport", "Hazmat certified drivers for safe dangerous goods transportation"].map((item, index) => <div key={index} className="flex items-start">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-20">
            {[{
              ...
              icon: Clock,
              color: "orange"
            }].map((stat, index) => <div key={index} className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200/30 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 text-center">
          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[{
                ...
                icon: Star
              }].map((value, index) => <div key={index} className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-blue-200/30 shadow-xl hover:shadow-2xl transition-all duration-300 text-center">
          ...
          <div className="bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 rounded-3xl p-12 text-white text-center shadow-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:8322823128">
                <Button size="lg" variant="outline" className="border-2 border-white px-8 py-4 text-lg font-semibold rounded-xl text-slate-50 bg-transparent">
